...
export const ko: Catalogue = {
  ...
  "task.agentMode.readOnly.description": "파일만 읽습니다. 바꾸지 않습니다.",
  "task.agentMode.workspace.label": "작업 영역 변경",
  "task.agentMode.workspace.description": "이 프로젝트의 파일을 바꿀 수 있습니다. 그 이상은 묻습니다.",
  "task.agentMode.fullAccess.label": "전체 접근",
  "task.agentMode.fullAccess.description": "컴퓨터 전체를, 매번 승인 없이 사용합니다.",
