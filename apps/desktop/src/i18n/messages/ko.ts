...
export const ko: Catalogue = {
  ...
  "settings.agents.envoyLlm.model.placeholder": "gpt-4o 또는 anthropic/claude-sonnet-4-5",
  "settings.agents.envoyLlm.model.detail": "모델 id, 또는 제공자/모델.",
  "settings.agents.envoyLlm.baseUrl": "기본 URL",
  "settings.agents.envoyLlm.baseUrl.placeholder": "선택 — LiteLLM 또는 프록시",
  "settings.agents.envoyLlm.baseUrl.detail": "비워 두면 제공자의 기본 엔드포인트를 사용합니다.",
