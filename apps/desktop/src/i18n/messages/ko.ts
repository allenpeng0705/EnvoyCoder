...
export const ko: Catalogue = {
  ...
  "settings.agent.unchecked": "아직 확인하지 않음",
  "settings.agent.checking": "확인 중…",
  "settings.agent.refused": "확인 실패",
  ...
  "settings.agents.row.check": "이 컴퓨터 확인",
  "settings.agents.row.checkAgain": "다시 확인",
  ...
  "settings.agents.row.needsInstall": "{agent}을(를) 설치하세요. 그러면 위 명령으로 실행됩니다. EnvoyCoder는 프로그램을 시작할 뿐, 대신 설치하지는 않습니다.",
  ...
  "settings.agent.unknown": "확인할 수 없음",
  "settings.agent.ready": "준비됨",
  "settings.agent.unsupported": "아직 구동할 수 없음",
  "settings.agent.needsBridge": "어댑터가 필요함",
  "settings.agent.provisional": "임시 복사본",
  ...
  "settings.agent.olderDaemon": "데몬이 한 버전 뒤처져 있어 어느 부분이 없는지 알 수 없습니다. EnvoyCoder를 다시 시작해 현재 데몬을 사용하세요.",
