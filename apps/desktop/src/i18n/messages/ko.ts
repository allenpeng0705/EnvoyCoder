...
export const ko: Catalogue = {
  ...
  "task.agentMode.workspace.label": "작업 영역 변경",
  ...
  "settings.approvals.detail": "명령이나 변경 전에 묻습니다. 파일을 읽을 때는 묻지 않습니다. 작업의 모드에서 더 허용할 수 있습니다.",
  ...
  "settings.agents.envoyLlm.baseUrl.detail":
    "비워 두면 그 제공자의 자체 주소를 씁니다. MiniMax는 OpenAI 형식입니다. anthropic/… 로 쓴 모델은 Anthropic 형식입니다. 한 주소가 둘 다는 아닙니다.",
