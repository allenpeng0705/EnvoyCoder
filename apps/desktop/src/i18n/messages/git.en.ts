...
export const git = {
  ...
  "error.gitMergeUnresolved": "A merge is not finished: {files} still has conflicts. Resolve them and finish the merge, or abort it.",
  "error.gitMergeNone": "No merge is in progress, so there is nothing to finish or abort.",
  "error.gitConflicted": "This repository has unresolved conflicts in {files}, from an operation EnvoyDev did not start. Finish or undo it there before doing anything else here.",
  "error.gitMergeResolveFailed": "The agent could not be started, so the merge was taken back and nothing changed: {detail}",
  "git.merge.stopped": "A merge stopped with conflicts.",
  "git.merge.stoppedFrom": "The merge of {branch} stopped with conflicts.",
  "git.merge.resolved": "All conflicts are resolved. Finish the merge to record it.",
  "git.merge.resolve": "Resolve with an agent",
  "git.merge.finish": "Finish the merge",
  "git.merge.abort": "Abort the merge",
  "git.merge.resolving": "An agent is resolving this merge: {task}.",
  "git.merge.aborted": "The merge was aborted, and nothing was merged.",
  "git.merge.recorded": "The merge was recorded.",
  "git.branches.conflictsChip": "Conflicts",
