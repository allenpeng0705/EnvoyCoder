...
export const zh: Catalogue = {
  ...
  "task.composer.agentMode.nextRun": "智能体会保持开始时使用的模式。你的选择将在下次运行时生效。",
  ...
  "task.composer.model.nextRun": "智能体会保持开始时所使用的模型。你的选择将在下次运行时生效。",
