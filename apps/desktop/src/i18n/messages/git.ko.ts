...
export const git = {
  ...
  "error.gitMergeUnresolved": "머지가 끝나지 않았습니다: {files}에 아직 충돌이 있습니다. 해결하고 머지를 끝내거나 취소하세요.",
  "error.gitMergeNone": "진행 중인 머지가 없어 끝내거나 취소할 것이 없습니다.",
  "error.gitConflicted": "이 저장소에는 해결되지 않은 충돌이 있습니다: {files}. EnvoyDev가 시작한 작업이 아닙니다. 여기서 다른 일을 하기 전에 그쪽에서 끝내거나 되돌리세요.",
  "error.gitMergeResolveFailed": "에이전트를 시작할 수 없어 머지를 되돌렸고 아무것도 바뀌지 않았습니다: {detail}",
  "git.merge.stopped": "머지가 충돌로 멈췄습니다.",
  "git.merge.stoppedFrom": "{branch} 머지가 충돌로 멈췄습니다.",
  "git.merge.resolved": "모든 충돌이 해결되었습니다. 머지를 끝내면 기록됩니다.",
  "git.merge.resolve": "에이전트로 해결",
  "git.merge.finish": "머지 끝내기",
  "git.merge.abort": "머지 취소",
  "git.merge.resolving": "에이전트가 이 머지를 해결하고 있습니다: {task}.",
  "git.merge.aborted": "머지를 취소했습니다. 아무것도 병합되지 않았습니다.",
  "git.merge.recorded": "머지를 기록했습니다.",
  "git.branches.conflictsChip": "충돌",
