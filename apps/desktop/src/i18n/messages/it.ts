...
export const it: Catalogue = {
  ...
  "sidebar.project.remove.confirm":
    "Rimuovere “{project}” da EnvoyCoder? Le sue attività lasciano la barra e vengono archiviate — dal disco non viene eliminato nulla.",
  ...
  "settings.agents.catalog.browse.title": "Ricette che EnvoyCoder sa pilotare. Se questa macchina può eseguirne una va misurato: non si verifica nulla finché non lo chiedi, una riga alla volta, perché un controllo percorre le cartelle dei programmi di questa macchina.",
  ...
  "settings.agents.row.restart": "Riavvia EnvoyCoder",
  ...
  "error.connectorNotFetchable": "{harness} non ha un connettore pubblicato su npm, quindi EnvoyCoder non può scaricarlo. Installalo invece.",
  ...
  "settings.agents.manual.open.title": "Se hai già un agente di coding che parla l'Agent Client Protocol e non è nel catalogo, dichiaralo qui. EnvoyCoder lo avvierà e lo sonderà esattamente come gli altri.",
  ...
  "settings.agents.manual.transport": "Come EnvoyCoder deve parlargli",
  ...
  "settings.agent.verdict.legacy.line": "EnvoyCoder è una versione indietro",
  "settings.agent.verdict.legacy.why":
    "Questa finestra parla con un daemon EnvoyCoder più vecchio, quindi non può dire cosa può fare questa macchina con {agent}. Sulla tua macchina non manca nulla — le due metà dell’app sono build diverse.",
  "settings.agent.verdict.unlooked.line": "EnvoyCoder non ha potuto verificare questa macchina",
  "settings.agent.verdict.unlooked.why":
    "Questa è una nostra lacuna, non un verdetto su {agent}: EnvoyCoder non ha potuto leggere le cartelle dei programmi di questa macchina, quindi non sa nulla se l’agente sia installato. Da questa riga non c’è niente che tu debba installare.",
  "settings.agent.verdict.app.restart": "Riavvia EnvoyCoder",
  "settings.agent.verdict.connector.lead": "Installato — richiede il suo connettore",
  "settings.agent.verdict.connector.why":
    "{agent} è installato. EnvoyCoder ha bisogno del suo connettore per pilotarlo, ed è l’unico pezzo che manca:",
  ...
  "settings.agent.verdict.gap.line": "EnvoyCoder non può ancora pilotare questo agente",
  "settings.agent.verdict.gap.why":
    "È una lacuna di EnvoyCoder, non un programma mancante: {agent} si raggiunge tramite un tipo di interfaccia per cui questa build non ha un adattatore, e reinstallarlo non cambierebbe nulla. La tua macchina non ha alcun problema.",
  ...
  "settings.agent.verdict.env.why":
    "{agent} è installato. Imposta {names} nell’ambiente in cui è stato avviato il daemon di EnvoyCoder — un valore può venire solo da te, perché EnvoyCoder non scrive mai una credenziale.",
  ...
  "settings.agent.fact.verified.never":
    "Non ancora — EnvoyCoder avvia un agente per scoprirlo, quindi arriva quando gira un’attività, non quando si apre questa pagina.",
  "settings.agent.fact.publishes": "Cosa pubblica",
  "settings.agent.fact.env.recipe": "Fornita da questa ricetta",
  "settings.agent.fact.env.set": "Impostata nell’ambiente di EnvoyCoder",
  ...
  "settings.agent.tier.builtIn": "Fa parte di EnvoyCoder",
  "settings.agent.tier.catalogued": "Uno strumento del catalogo di EnvoyCoder",
  ...
  "settings.agent.notDeclared": "Il servizio con cui parla questa finestra non ha inviato ciò che {agent} dichiara di sé, quindi qui non c'è nulla da mostrare. Succede quando i due provengono da versioni diverse; riavvia EnvoyCoder perché entrambi provengano dalla stessa versione.",
  ...
  "settings.about.mismatch": "Questa finestra è {window} e il servizio è {daemon} — versioni diverse. Un servizio di un'altra versione può rifiutare impostazioni che questa finestra scrive; riavvia EnvoyCoder perché entrambi provengano dalla stessa versione.",
  ...
  "note.settings.retired":
    "{file} conteneva {key}, che questa versione non ha più. EnvoyCoder l'ha scartata e ha conservato ogni altra impostazione.",
  "note.settings.unknown":
    "{file} conteneva {key}, che questa versione non riconosce. EnvoyCoder l'ha scartata e ha conservato ogni altra impostazione.",
