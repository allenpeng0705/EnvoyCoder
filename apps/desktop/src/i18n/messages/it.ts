...
export const it: Catalogue = {
  ...
  "settings.sections.note": "Le impostazioni di questa finestra, sezione per sezione. In ogni sezione c'è qualcosa da leggere o da modificare.",
  ...
  "settings.agents.add.heading": "Aggiungi un agente",
  "settings.agents.add.note": "Queste sono ricette che EnvoyCoder sa guidare. Se questa macchina possa eseguirne una è un fatto da misurare, quindi qui non si verifica nulla finché non lo chiedi tu — una riga alla volta, perché una verifica percorre le cartelle dei programmi di questa macchina, e una pagina che lo facesse per tutte all’apertura spenderebbe la tua macchina per agenti che non hai mai guardato.",
  ...
  "settings.agents.manual.note": "Se hai già un agente di programmazione che parla l’Agent Client Protocol e non è nel catalogo qui sopra, dichiaralo qui. EnvoyCoder lo avvierà e lo sonderà esattamente come gli altri.",
  ...
  "settings.agents.manual.env.detail": "Solo nomi, separati da virgole o a capo — mai i valori. EnvoyCoder legge ogni valore dall’ambiente in cui gira il suo daemon, così una credenziale non viene mai scritta su disco.",
  "settings.agents.manual.transport": "Come EnvoyCoder deve parlargli",
  "settings.agents.manual.transport.detail": "Qui non c’è un valore predefinito di proposito: indovinare manda un handshake Agent Client Protocol a un programma che non risponderà mai, oppure segnala come non supportato un agente che funziona. Solo tu puoi vedere quale dei due casi è.",
  ...
  "settings.shortcuts.note": "Ogni tasto che questa finestra ascolta, letto dalla stessa tabella che legge il livello tastiera. Un tasto che non è in questo elenco non fa nulla in questa versione.",
  ...
  "settings.machine.note": "Tutto ciò che è su questa pagina è ciò che il servizio ha detto di sé quando questa finestra si è collegata.",
  ...
  "settings.machine.stateDir.detail": "Una cartella su questo computer: le tue impostazioni, l'elenco dei progetti e i resoconti che un'attività conserva.",
  "settings.machine.home.title": "La cartella che considera casa",
  "settings.machine.home.detail": "Un percorso che digiti come ~ indica questa cartella. Nient'altro viene letto da lì, e questa finestra non vi scrive nulla.",
  ...
  "settings.about.note": "EnvoyCoder è fatto di due metà — questa finestra e il servizio che salva le tue impostazioni ed esegue i tuoi agenti — e vengono compilate insieme, quindi le loro versioni dovrebbero coincidere.",
