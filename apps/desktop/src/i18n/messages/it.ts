...
export const it: Catalogue = {
  ...
  "settings.agent.unchecked": "Non ancora verificato",
  "settings.agent.checking": "Verifica in corso…",
  "settings.agent.refused": "Verifica non riuscita",
  ...
  "settings.agents.row.check": "Verifica questa macchina",
  "settings.agents.row.checkAgain": "Verifica di nuovo",
  ...
  "settings.agents.row.needsInstall": "Installa {agent} — poi gira come il comando qui sopra. EnvoyCoder avvia il programma, non lo installa al posto tuo.",
  ...
  "settings.agent.unknown": "Impossibile verificare",
  "settings.agent.ready": "Pronto",
  "settings.agent.unsupported": "Non ancora pilotabile",
  "settings.agent.needsBridge": "Richiede il suo adattatore",
  "settings.agent.provisional": "Copia temporanea",
  ...
  "settings.agent.olderDaemon": "Il tuo daemon è una versione indietro e non può dire quale parte manca. Riavvia EnvoyCoder per usare quello attuale.",
