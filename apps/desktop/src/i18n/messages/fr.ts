...
export const fr: Catalogue = {
  ...
  "settings.agents.add.heading": "Ajouter un agent",
  "settings.agents.add.note": "Voici des recettes qu’EnvoyCoder sait piloter. Savoir si cette machine peut en exécuter une se mesure : rien n’est donc vérifié ici avant que vous le demandiez — une ligne à la fois, car une vérification parcourt les dossiers de programmes de cette machine, et une page qui le ferait pour toutes à l’ouverture dépenserait votre machine pour des agents que vous n’avez jamais regardés.",
  ...
  "settings.agents.manual.note": "Si vous avez déjà un agent de codage qui parle l’Agent Client Protocol et qu’il n’est pas dans le catalogue ci-dessus, déclarez-le ici. EnvoyCoder le lancera et le sondera exactement comme les autres.",
  ...
  "settings.agents.manual.env.detail": "Des noms uniquement, séparés par des virgules ou des retours à la ligne — jamais les valeurs. EnvoyCoder lit chaque valeur dans l’environnement où tourne son démon, si bien qu’un identifiant n’est jamais écrit sur le disque.",
  "settings.agents.manual.transport": "Comment EnvoyCoder doit lui parler",
  "settings.agents.manual.transport.detail": "Il n’y a volontairement aucune valeur par défaut ici : deviner envoie une poignée de main Agent Client Protocol à un programme qui n’y répondra jamais, ou déclare non pris en charge un agent qui fonctionne. Vous seul pouvez voir de quel cas il s’agit.",
