...
export const fr: Catalogue = {
  ...
  "settings.agent.unchecked": "Pas encore vérifié",
  "settings.agent.checking": "Vérification…",
  "settings.agent.refused": "Échec de la vérification",
  ...
  "settings.agents.row.check": "Vérifier cette machine",
  "settings.agents.row.checkAgain": "Vérifier à nouveau",
  ...
  "settings.agents.row.needsInstall": "Installez {agent} — il tournera ensuite comme la commande ci-dessus. EnvoyCoder lance le programme, il ne l'installe pas pour vous.",
  ...
  "settings.agent.unknown": "Vérification impossible",
  "settings.agent.ready": "Prêt",
  "settings.agent.unsupported": "Pas encore pilotable",
  "settings.agent.needsBridge": "Nécessite son adaptateur",
  "settings.agent.provisional": "Copie temporaire",
  ...
  "settings.agent.olderDaemon": "Votre démon a une version de retard et ne peut pas dire quelle partie manque. Redémarrez EnvoyCoder pour utiliser la version actuelle.",
