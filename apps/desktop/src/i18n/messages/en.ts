...
export const en = {
  ...
  "settings.section.teams.detail":
    "Create a team, share one token, and run collaborative jobs across machines.",
  "settings.teams.label": "Team name",
  "settings.teams.memberLabel": "This machine’s label",
  "settings.teams.joinOk": "Joined {label}.",
  "settings.teams.copied": "Token copied.",
  "settings.teams.rotateConfirm": "Everyone must paste a new token. Continue?",
  "settings.teams.dissolveConfirm": "Running jobs on this team will cancel. Dissolve the team?",
  "settings.teams.expires": "Token expires {when}",
  "settings.teams.jobTitle": "Job title",
  "settings.teams.jobGoal": "Goal",
  "settings.teams.jobTeam": "Team",
  "settings.teams.createJob": "Create job",
  "job.pane.stopConfirm": "Stop all steps on all machines?",
  "job.pane.report": "Report",
  "job.pane.kick": "Kick",
  "job.pane.kickConfirm": "Remove {label} from the team. Their step will stop.",
  "job.pane.stallAutomation": "Enable stall automation (after board is visible)",
  "job.pane.noOnline": "Start needs at least one online peer (or this machine).",
  "job.pane.tokenExpiring": "Team token expires soon — rotate it before peers lose access.",
  "job.pane.pendingOffers": "Waiting for Accept on this machine",
  "job.pane.acceptOffer": "Accept",
  "job.pane.refuseOffer": "Refuse",
  "job.pane.thisMachine": "This machine",
  "job.pane.failConfirm": "Force-fail this step and stop its run?",
  "job.pane.forceFail": "Force fail",
  "job.pane.localAutoAccept": "Auto-accept roles on this machine",
  "job.pane.reassignConfirm": "Reassign this step to {label}?",
  "job.pane.reassignConfirmNone":
    "Reassign this step? No other online machine offers this role — the daemon will look again.",
  "job.pane.ledgerFilter": "Filter ledger",
  "job.pane.ledgerAll": "All notes",
  "job.pane.ledgerByStep": "By step",
  "job.pane.ledgerByMember": "By peer",
  "job.pane.refuseReasonPrompt": "Why refuse this step? (short reason)",
  "job.pane.approve": "Allow",
  "job.pane.deny": "Don’t allow",
  "job.pane.needsApproval": "Waiting for approval on this step",
  "job.pane.openRun": "Open run",
  "job.pane.hasGap": "Event gap — some progress may be missing",
  "settings.teams.roles": "Roles this machine offers",
  "settings.teams.role.plan": "Plan",
  "settings.teams.role.implement": "Implement",
  "settings.teams.role.review": "Review",
  "settings.teams.role.observe": "Observe",
  "settings.teams.tokenExpiring": "Team token expires soon — rotate it before peers lose access.",
  "sidebar.jobs": "Jobs",
  ...
  "error.team.missing": "No team with that id.",
  "error.team.badToken": "That team token is not valid.",
  "error.team.expired": "That team token has expired.",
  "error.team.unknownMember": "That member is not on this team.",
  "error.team.kickLocal": "Cannot kick this machine from its own team.",
  "error.job.missing": "No job with that id.",
  "error.job.stepMissing": "No step with that id.",
  "error.job.stepsLocked": "Steps can only be edited while the job is drafting or running.",
  "error.job.writerLock": "Two implement steps share worktree key “{key}”.",
  "error.job.notRunning": "The job is not in a state that accepts this action.",
  "error.job.deps": "Step dependencies are not satisfied.",
  "error.job.noSteps": "Add at least one step before starting.",
  "error.job.offerMissing": "No offer with that id.",
  "error.job.offerClosed": "That offer is no longer pending.",
  "error.job.exhausted": "Step exhausted retries and reassigns.",
  "error.job.pathMissing": "Path missing on this machine.",
  "error.job.failed": "This job has failed.",
  "settings.teams.title": "Teams",
  "settings.teams.blurb": "Create a team, share one token, and collaborate on jobs across machines.",
  "settings.teams.create": "Create team",
  "settings.teams.join": "Join team",
  "settings.teams.copyToken": "Copy team token",
  "settings.teams.rotate": "Rotate token",
  "settings.teams.dissolve": "Dissolve team",
  "settings.teams.tokenOnce": "Share this invite with other EnvoyDev machines. It is shown once.",
  "settings.teams.pasteToken": "Paste team invite or token",
  "settings.teams.empty": "No teams yet. Create one to start collaborative jobs.",
  "settings.teams.inboundOffers": "Step offers for this machine",
  "settings.teams.acceptOffer": "Accept",
  "settings.teams.refuseOffer": "Refuse",
  "settings.teams.memberships": "Teams you joined",
  "settings.teams.autoAccept": "Auto-accept roles",
  "job.pane.title": "Job",
  "job.pane.steps": "Steps",
  "job.pane.peers": "Peers",
  "job.pane.ledger": "Ledger",
  "job.pane.start": "Start job",
  "job.pane.pause": "Pause",
  "job.pane.stop": "Stop job",
  "job.pane.stopStep": "Stop step",
  "job.pane.reassign": "Reassign",
  "job.pane.suggest": "Suggest steps",
