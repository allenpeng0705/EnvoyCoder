...
export const de: Catalogue = {
  ...
  "settings.agents.catalog.browse.title": "Rezepte, die EnvoyCoder zu steuern weiß. Ob dieser Rechner eines ausführen kann, muss gemessen werden — deshalb wird nichts geprüft, bis du danach fragst, und dann eine Zeile nach der anderen, denn eine Prüfung durchsucht die Programmordner dieses Rechners.",
  ...
  "settings.agents.row.restart": "EnvoyCoder neu starten",
  ...
  "error.connectorNotFetchable": "{harness} hat keinen auf npm veröffentlichten Connector, daher kann EnvoyCoder ihn nicht laden. Installiere ihn stattdessen.",
  ...
  "settings.agents.manual.open.title": "Wenn du bereits einen Coding-Agenten hast, der das Agent Client Protocol spricht, und er steht nicht im Katalog, dann deklariere ihn hier. EnvoyCoder startet und prüft ihn genau wie die anderen.",
  ...
  "settings.agents.manual.transport": "Wie EnvoyCoder mit ihm sprechen muss",
  ...
  "settings.agent.verdict.legacy.line": "EnvoyCoder ist einen Build im Rückstand",
  "settings.agent.verdict.legacy.why":
    "Dieses Fenster spricht mit einem älteren EnvoyCoder-Daemon und kann deshalb nicht sagen, was dieser Computer mit {agent} anfangen kann. Auf deinem Computer fehlt nichts — die beiden Hälften der App sind verschiedene Builds.",
  "settings.agent.verdict.unlooked.line": "EnvoyCoder konnte diesen Computer nicht prüfen",
  "settings.agent.verdict.unlooked.why":
    "Das ist unsere Lücke und kein Urteil über {agent}: EnvoyCoder konnte die Programmordner dieses Computers nicht lesen und weiß deshalb nichts darüber, ob der Agent installiert ist. Wegen dieser Zeile gibt es nichts für dich zu installieren.",
  "settings.agent.verdict.app.restart": "EnvoyCoder neu starten",
  "settings.agent.verdict.connector.lead": "Installiert — braucht seine Anbindung",
  "settings.agent.verdict.connector.why":
    "{agent} ist installiert. EnvoyCoder braucht seine Anbindung, um ihn zu steuern, und genau dieses Stück fehlt:",
  ...
  "settings.agent.verdict.gap.line": "EnvoyCoder kann diesen Agenten noch nicht steuern",
  "settings.agent.verdict.gap.why":
    "Das ist eine Lücke von EnvoyCoder, kein fehlendes Programm: {agent} wird über eine Art von Schnittstelle erreicht, für die dieser Build keinen Adapter hat, und eine erneute Installation würde nichts ändern. Mit deinem Computer ist alles in Ordnung.",
  ...
  "settings.agent.verdict.env.why":
    "{agent} ist installiert. Setze {names} in der Umgebung, in der der Daemon von EnvoyCoder gestartet wurde — ein Wert kann nur von dir kommen, denn EnvoyCoder schreibt niemals ein Zugangsdatum auf.",
  ...
  "settings.agent.fact.verified.never":
    "Noch nicht — EnvoyCoder startet einen Agenten, um das herauszufinden; es kommt also, wenn eine Aufgabe läuft, und nicht, wenn diese Seite geöffnet wird.",
  "settings.agent.fact.publishes": "Was er veröffentlicht",
  "settings.agent.fact.env.recipe": "Von diesem Rezept bereitgestellt",
  "settings.agent.fact.env.set": "In der Umgebung von EnvoyCoder gesetzt",
  ...
  "settings.agent.tier.builtIn": "Ist Teil von EnvoyCoder",
  "settings.agent.tier.catalogued": "Ein Werkzeug aus dem Katalog von EnvoyCoder",
  ...
  "settings.agent.notDeclared": "Der Dienst, mit dem dieses Fenster spricht, hat nicht geschickt, was {agent} über sich selbst angibt — hier gibt es also nichts zu zeigen. Das passiert, wenn beide aus verschiedenen Versionen stammen; starte EnvoyCoder neu, damit beide aus einer Version kommen.",
  ...
  "settings.about.mismatch": "Dieses Fenster ist {window} und der Dienst ist {daemon} — verschiedene Versionen. Ein Dienst aus einer anderen Version kann Einstellungen ablehnen, die dieses Fenster schreibt; starte EnvoyCoder neu, damit beide aus einer Version kommen.",
  ...
  "note.settings.retired":
    "{file} enthielt {key}; diese Einstellung gibt es in diesem Build nicht mehr. EnvoyCoder hat sie verworfen und jede andere Einstellung behalten.",
  "note.settings.unknown":
    "{file} enthielt {key}; diese Einstellung kennt dieser Build nicht. EnvoyCoder hat sie verworfen und jede andere Einstellung behalten.",
