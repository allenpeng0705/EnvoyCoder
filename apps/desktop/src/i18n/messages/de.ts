...
export const de: Catalogue = {
  ...
  "settings.agent.unchecked": "Noch nicht geprüft",
  "settings.agent.checking": "Wird geprüft…",
  "settings.agent.refused": "Prüfung fehlgeschlagen",
  ...
  "settings.agents.row.check": "Diesen Rechner prüfen",
  "settings.agents.row.checkAgain": "Erneut prüfen",
  ...
  "settings.agents.row.needsInstall": "Installiere {agent} — dann läuft es als der Befehl oben. EnvoyCoder startet das Programm, installiert es aber nicht für dich.",
  ...
  "settings.agent.unknown": "Konnte nicht prüfen",
  "settings.agent.ready": "Bereit",
  "settings.agent.unsupported": "Noch nicht steuerbar",
  "settings.agent.needsBridge": "Braucht seinen Adapter",
  "settings.agent.provisional": "Vorläufige Kopie",
  ...
  "settings.agent.olderDaemon": "Dein Daemon ist eine Version älter und kann nicht sagen, welcher Teil fehlt. Starte EnvoyCoder neu, um den aktuellen zu verwenden.",
