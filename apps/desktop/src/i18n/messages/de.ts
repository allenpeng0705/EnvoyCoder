...
export const de: Catalogue = {
  ...
  "settings.sections.note": "Die Einstellungen dieses Fensters, Bereich für Bereich. In jedem Bereich gibt es etwas zu lesen oder zu ändern.",
  ...
  "settings.agents.add.heading": "Einen Agenten hinzufügen",
  "settings.agents.add.note": "Das sind Rezepte, die EnvoyCoder zu steuern weiß. Ob dieser Rechner eines davon ausführen kann, muss gemessen werden — deshalb wird hier nichts geprüft, bis du danach fragst: eine Zeile nach der anderen, denn eine Prüfung durchsucht die Programmordner dieses Rechners, und eine Seite, die das beim Öffnen für alle täte, würde deinen Rechner für Agenten aufwenden, die du nie angesehen hast.",
  ...
  "settings.agents.manual.note": "Wenn du bereits einen Coding-Agenten hast, der das Agent Client Protocol spricht, und er steht nicht im Katalog oben, dann deklariere ihn hier. EnvoyCoder startet und prüft ihn genau wie die anderen.",
  ...
  "settings.agents.manual.env.detail": "Nur Namen, durch Kommas oder Zeilenumbrüche getrennt — niemals die Werte. EnvoyCoder liest jeden Wert aus der Umgebung, in der sein Daemon läuft; so wird nie ein Geheimnis auf die Festplatte geschrieben.",
  "settings.agents.manual.transport": "Wie EnvoyCoder mit ihm sprechen muss",
  "settings.agents.manual.transport.detail": "Hier gibt es absichtlich keinen Standardwert: Raten schickt einem Programm einen Agent-Client-Protocol-Handshake, das ihn nie beantworten wird — oder meldet einen funktionierenden Agenten als nicht unterstützt. Welcher Fall vorliegt, siehst nur du.",
  ...
  "settings.shortcuts.note": "Jede Taste, auf die dieses Fenster hört — gelesen aus derselben Tabelle, die die Tastaturschicht liest. Eine Taste, die hier nicht steht, tut in dieser Version nichts.",
  ...
  "settings.machine.note": "Alles auf dieser Seite hat der Dienst selbst gesagt, als dieses Fenster sich mit ihm verbunden hat.",
  ...
  "settings.machine.stateDir.detail": "Ein Ordner auf diesem Computer: deine Einstellungen, die Projektliste und die Transkripte, die eine Aufgabe behält.",
  "settings.machine.home.title": "Der Ordner, den er als Zuhause ansieht",
  "settings.machine.home.detail": "Ein Pfad, den du als ~ eintippst, bedeutet diesen Ordner. Sonst wird nichts daraus gelesen, und dieses Fenster schreibt nichts dorthin.",
  ...
  "settings.about.note": "EnvoyCoder besteht aus zwei Hälften — diesem Fenster und dem Dienst, der deine Einstellungen speichert und deine Agenten ausführt — und beide werden zusammen gebaut, ihre Versionen sollten also gleich sein.",
