...
export function stubAgentActions(overrides: Partial<AgentActions> = {}): AgentActions {
  ...
  const base: AgentActions = {
    ...
    createTeam: vi.fn(async () => REFUSAL),
    listTeams: vi.fn(async () => REFUSAL),
    teamStatus: vi.fn(async () => REFUSAL),
    rotateTeamToken: vi.fn(async () => REFUSAL),
    dissolveTeam: vi.fn(async () => REFUSAL),
    joinTeam: vi.fn(async () => REFUSAL),
    createJob: vi.fn(async () => REFUSAL),
    listJobs: vi.fn(async () => REFUSAL),
    getJob: vi.fn(async () => REFUSAL),
    startJob: vi.fn(async () => REFUSAL),
    pauseJob: vi.fn(async () => REFUSAL),
    stopJob: vi.fn(async () => REFUSAL),
    stopJobStep: vi.fn(async () => REFUSAL),
    reassignJobStep: vi.fn(async () => REFUSAL),
    suggestJobSteps: vi.fn(async () => REFUSAL),
    updateJobSteps: vi.fn(async () => REFUSAL),
    kickMember: vi.fn(async () => REFUSAL),
    setJobStallAutomation: vi.fn(async () => REFUSAL),
    listInboundJobOffers: vi.fn(async () => REFUSAL),
    acceptInboundJobStepOffer: vi.fn(async () => REFUSAL),
    refuseInboundJobStepOffer: vi.fn(async () => REFUSAL),
    listTeamMemberships: vi.fn(async () => REFUSAL),
    setMemberAcceptPolicy: vi.fn(async () => REFUSAL),
    listJobOffers: vi.fn(async () => REFUSAL),
    getTeamToken: vi.fn(async () => REFUSAL),
    acceptLocalJobStepOffer: vi.fn(async () => REFUSAL),
    refuseLocalJobStepOffer: vi.fn(async () => REFUSAL),
    acceptJobStepOffer: vi.fn(async () => REFUSAL),
    refuseJobStepOffer: vi.fn(async () => REFUSAL),
    failJobStep: vi.fn(async () => REFUSAL),
    answerJobStepApproval: vi.fn(async () => REFUSAL),
  };
